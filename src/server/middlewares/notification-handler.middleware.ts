...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'guest.create': {
    roles: ['owner', 'healthcare-provider'],
    key: 'new-guest-registration',
    tenantPath: ['organization', 'guest'],
    userPath: [],
  },
  'guest.update': {
    roles: ['owner', 'healthcare-provider'],
    key: 'guest-medication-update',
    tenantPath: ['organization', 'guest'],
    userPath: [],
  },
  'answer.create': {
    roles: ['owner', 'healthcare-provider'],
    key: 'new-phq-9-answer',
    tenantPath: ['organization', 'guest', 'phq_9_question', 'answer'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'healthcare-provider'];
