...
import { getPhq9QuestionById, updatePhq9QuestionById } from 'apiSdk/phq-9-questions';
...
function Phq9QuestionEditPage() {
  ...
  const handleSubmit = async (values: Phq9QuestionInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updatePhq9QuestionById(id, values);
      mutate(updated);
      resetForm();
