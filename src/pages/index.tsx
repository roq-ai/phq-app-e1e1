  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock a seamless healthcare journey with Phq app - your one-stop platform for logging PHQ 9 questions, tracking medication, and visualizing your health progress over time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1576091160550-2173dba999ef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxoZWFsdGhjYXJlfGVufDB8fHx8MTY5NDc0NDk0OHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock a seamless healthcare journey with Phq app - your one-stop platform for logging PHQ 9 questions, tracking medication, and visualizing your health progress over time.`}
            </Text>
            <Box
